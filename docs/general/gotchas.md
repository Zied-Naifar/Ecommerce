...
If you have pages that should be available throughout the app, like a `NavigationBar` (they aren't route specific), you need to add their respective reducers to the root reducer with the help of `combineReducers`.
...
import navigationBarReducer from 'pages/NavigationBar/reducer';
